...
class element extends \mod_customcert\element {
    ...
    public function render($pdf, $preview, $user) {
        ...
        if ($file) {
            ...
            /*custom location for image*/
            $location = base_url()."/assets/img/profile/".$user->profile['profilepicture'];
            //print_r($location);
            /*End location*/
            ...
            /*End location*/
            $pdf->Image($location, $this->element->posx, $this->element->posy, $imageinfo->width, $imageinfo->height);
        }else{//section added for profile picture to be rendered in PDF.   /* rajesh.nadar@camplus.co.in*/
            $location = base_url()."/assets/img/profile/".$user->profile['profilepicture'];
            $pdf->Image($location, $this->element->posx, $this->element->posy, $imageinfo->width, $imageinfo->height);
        }
    ...
    public function render_html() {
        ...
        $url = base_url()."/assets/img/profile/".$USER->profile['profilepicture'];
