...
// namespace Lavacharts;

require_once(APP_PATH.'third_party/Lavacharts/src/Charts/Chart'); 
require_once(APP_PATH.'third_party/Lavacharts/src/Charts/ChartFactory'); 
require_once(APP_PATH.'third_party/Lavacharts/src/Dashboards/Dashboard'); 
require_once(APP_PATH.'third_party/Lavacharts/src/Dashboards/DashboardFactory'); 
require_once(APP_PATH.'third_party/Lavacharts/src/Dashboards/Filters/Filter'); 
require_once(APP_PATH.'third_party/Lavacharts/src/Dashboards/Filters/FilterFactory'); 
require_once(APP_PATH.'third_party/Lavacharts/src/Dashboards/Wrappers/ChartWrapper'); 
require_once(APP_PATH.'third_party/Lavacharts/src/Dashboards/Wrappers/ControlWrapper'); 
require_once(APP_PATH.'third_party/Lavacharts/src/DataTables/DataTable'); 
require_once(APP_PATH.'third_party/Lavacharts/src/DataTables/Formats/Format'); 
require_once(APP_PATH.'third_party/Lavacharts/src/Exceptions/InvalidLabel'); 
require_once(APP_PATH.'third_party/Lavacharts/src/Exceptions/InvalidLavaObject'); 
require_once(APP_PATH.'third_party/Lavacharts/src/Javascript/ScriptManager'); 
require_once(APP_PATH.'third_party/Lavacharts/src/Support/Html/HtmlFactory'); 
require_once(APP_PATH.'third_party/Lavacharts/src/Support/Psr4Autoloader'); 
require_once(APP_PATH.'third_party/Lavacharts/src/Values/ElementId'); 
require_once(APP_PATH.'third_party/Lavacharts/src/Values/Label'); 
require_once(APP_PATH.'third_party/Lavacharts/src/Values/StringValue'); 
require_once(APP_PATH.'third_party/Lavacharts/src/Support/Contracts/RenderableInterface as Renderable'); 
...
class Lavacharts
{
    ...
    public function render($type, $label, $elementId = null, $div = false)
    {
        ...
        if (is_array($elementId)) {
            $div = $elementId; // @TODO allow missing element ids to require_once('') renderable instance's id
        }
