...
<section class="inner-wrapper">
  <div class="container">
    <div class="row">
      <h2>CDIMS <span>Classroom course Enrolment</span> </h2>
            ...
            <form action='<?php echo base_url('register/payment-for-course');?>' name="payuForm" method='post'>
              <div class="row" >
                <div class="col-md-6">
                  ...
                  <input type="text" readonly class="txt" name="c_type" value="3 day classroom course certification" disabled />                  
                  <input type="hidden" readonly class="txt" id="c_type_hid" name="c_type_hid" value="crc"  />                  
                </div>
                <div class="col-md-6">
                  <label>Amount </label><br />
                  <input type="text" class="txt" readonly id="amount" name="amount" value="30000" disabled />
                </div>                
              </div>
              <div class="row" >
                <div class="col-md-6">
                  <label>Select Location </label><br />
                  <select name="location" type="text" class="txt" id="location" aria-invalid="false">
                ...
                <div class="col-md-6">
                  ...
                  <input type="text" class="txt" name="courselist" id="courselist" readonly>
                  <!-- <select name="courselist" type="text" class="txt" id="" aria-invalid="false">
                    <option value="17_18_19_may_2017">17,18,19 May 2017</option>
                    <option value="3rd_week_july_2017">3rd Week-July 2017</option>
                    <option value="3rd_week_august_2017">3rd Week-August 2017</option>
                  </select> -->
                </div>
              ...
              <div class="row">
                 <div class="col-sm-6" >
                    ...
                    <input type="text" class="txt"  id="coupon_code" name="coupon_code" value=""  />
                </div>
              </div>            
              <center>
                <div class="btn-shapes">
                    <input type="button" value="Pay" name="Pay" class="btn btn-primary" id="pay_for_crc" /> 
                </div>          
              </center>
                ...
                <div class="modal-dialog">
                  <div class="modal-content">
                      ...
                      <div class="modal-body">
                        <div class="row">
                          <div class="col-md-12 unordered-list default-list about_justify">
...
$(document).ready(function(){
    ...
    $('#location').on('change',function(){
      ...
      switch(location){
        case 'gandhinagar':
          $('#courselist').val('17,18,19 May 2017');
          break;
        case 'delhi':
          $('#courselist').val('3rd Week-July 2017');
          break;
        case 'mumbai':
          $('#courselist').val('3rd Week-August 2017');
          break;
      }
      
    })
    $('#pay_for_crc').click(function(){
        var fd={coupon_code:$('#coupon_code').val(),c_type_hid:$('#c_type_hid').val()}
        $.ajax({
