...
$config['smtp_user']        = 'training@chetandalal.com';
$config['smtp_pass']        = 'training@123456';
...
$config['dkim_domain']      = 'chetandalal.com';                       // DKIM signing domain name, for exmple 'example.com'.
...
$config['dkim_selector']    = 'chetandalal';                       // DKIM selector.
$config['dkim_passphrase']  = '';                       // DKIM passphrase, used if your key is encrypted.
$config['dkim_identity']    = 'support@chetandalal.com';                       // DKIM Identity, usually the email address used as the source of the email.
