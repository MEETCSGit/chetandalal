...
$config['smtp_user']        = 'training@cdimsacademy.com';
$config['smtp_pass']        = 'India@123456';
...
// $config['dkim_domain']      = 'cdimsaced.com';                       // DKIM signing domain name, for exmple 'example.com'.
...
// $config['dkim_selector']    = 'zoho';                       // DKIM selector.
